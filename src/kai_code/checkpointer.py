...
class KaiFileCheckpointer(InMemorySaver):
    ...
    def put_writes(self, config: RunnableConfig, writes, task_id: str):  # type: ignore[override]
        out = super().put_writes(config, writes, task_id)
        self._save()
        return out
